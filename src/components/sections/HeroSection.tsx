  ...
  return (
    ...
    >
      <div
        ...
        style={{ fontFamily: "'Courier New', 'Menlo', monospace" }}
      >
        <span className="text-sm sm:text-base md:text-lg tracking-[0.15em] text-amber-400 drop-shadow-[0_0_6px_rgba(251,191,36,0.6)]">
          {messages.join("　　　")}
        </span>
      </div>
    </div>
  ...
  return (
    <section className="relative w-full bg-bg-main overflow-hidden">
      ...
      <div className="w-full border-b-2 border-text-heading">
        {/* Row 1: Top info cells */}
        <div className="grid grid-cols-12 border-b border-text-heading/20">
          <div className="col-span-2 border-r border-text-heading/20 px-3 py-2 flex items-center">
            <span className="text-[9px] sm:text-[10px] font-mono tracking-wider text-text-sub uppercase">
              est.2024
            </span>
          </div>
          <div className="col-span-2 border-r border-text-heading/20 px-3 py-2 flex items-center">
            <span className="text-[9px] sm:text-[10px] font-mono tracking-wider text-text-heading uppercase">
              Works
            </span>
          </div>
          <div className="col-span-2 border-r border-text-heading/20 px-3 py-2 flex items-center">
